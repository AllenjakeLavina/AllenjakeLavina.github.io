...
<div class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow max-w-7xl mx-auto px-4 py-10 bg-white rounded-lg shadow-xl">
        ...
        <div class="flex justify-center space-x-8 mb-10">
            ...
            <a href="https://www.instagram.com/lav_nlla/?hl=en" class="bg-gradient-to-r from-pink-500 to-pink-400 border border-pink-600 rounded-full p-4 shadow-lg hover:scale-110 transform transition duration-300" target="_blank">
